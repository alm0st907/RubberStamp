...
namespace YnabClientSpace
{
    using System = global::System;

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.20.0.0 (NJsonSchema v10.9.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class YnabClient 
    {
        private string _baseUrl = "https://api.ynab.com/v1";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<System.Text.Json.JsonSerializerOptions> _settings;

        public YnabClient(System.Net.Http.HttpClient httpClient)
        {
        ...
        /// </remarks>
        /// <param name="budget_id">The id of the budget. "last-used" can be used to specify the last used budget and "default" can be used if default budget selection is enabled (see: https://api.ynab.com/#oauth-default-budget).</param>
        /// <param name="body">The list of transactions to create</param>
        /// <returns>The bulk request was processed successfully</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<BulkResponse> BulkCreateTransactionsAsync(string budget_id, BulkTransactions body)
        {
            return BulkCreateTransactionsAsync(budget_id, body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>The bulk request was processed successfully</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<BulkResponse> BulkCreateTransactionsAsync(string budget_id, BulkTransactions body, System.Threading.CancellationToken cancellationToken)
        {
            if (budget_id == null)
                throw new System.ArgumentNullException("budget_id");
